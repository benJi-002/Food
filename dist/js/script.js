...
function cards() {
  ...
  class MenuCard {
    ...
    changeToBYN() {
      this.price = (this.price * this.trnasfer).toFixed(2); //оставляем два знака после запятой
    }
  ...
  const getResources = async url => {
    //async говороит функции, что внутри будет асинхронный код
  ...
  //         function toBYN(price, transfer) {
  //             return (price * transfer).toFixed(2); //оставляем два знака после запятой
  //         }
  //         element.innerHTML = `
  ...
  //             <div class="menu__item-price">
  //                 <div class="menu__item-cost">Цена:</div>
  //                 <div class="menu__item-total"><span>${toBYN(price, 2.8)}</span> руб/день</div>
  //             </div>
  //         `;
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.promise.finally */ "./node_modules/core-js/modules/es.promise.finally.js");
...
function forms() {
  ...
  const postData = async (url, data) => {
    ...
    const res = await fetch(url, {
      // await - переменная res будет ожидать выполнения промиса
      method: 'POST',
      headers: {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      const json = JSON.stringify(Object.fromEntries(formData.entries())); // реализация POST при помощи fetch
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  /* Формы */
  form = __webpack_require__(/*! ./modules/forms */ "./src/js/modules/forms.js"),
