...
"use strict";
__webpack_require__.r(__webpack_exports__);
function tabs(tabsSelector, tabsCpontentSelector, tabsParentSelector, activeClass) {
  const tabs = document.querySelectorAll(tabsSelector),
        tabsContent = document.querySelectorAll(tabsCpontentSelector),
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', '2023-05-20');
